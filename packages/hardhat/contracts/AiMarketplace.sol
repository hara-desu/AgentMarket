...
contract AIMP_SC {
    ...
    // For some reason there's an instance of a contract
    ...
    modifier isVerified(uint256 _token) {
        require(nftContract.isVerified(_token), "Model is not valid!");
        _;
    }
    ...
    //isOwnerAndValid(_token)
    function startAuction(
        address _owner,
        uint256 _token,
        uint256 _end
    ) public isOwnerAndValid(_token) {
